                ...
                ElevatedButton(
                  onPressed: () async {
                    if (_formKey.currentState?.validate() ?? false) {
                      ...
                      if (_currentPosition != null) {
                        try {
                          // Check if a client with the entered tax code already exists
                          print("CEAAAAAAA");
                          var existingClient = await apiService
                          ...
                          showDialog(
                            ...
                            int clientId = await apiService.createClient(
                              ...
                              totalOrder:
                                  double.parse(_totalOrderController.text)
                                      .toString(),
                            );
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) =>
                                    MeetingScreen(clientId: clientId),
                              ),
                            );
                          }
                        } catch (e) {
